 ...
 * @author thomas
 */
public class AddIndirectAnnotationDialog extends javax.swing.JDialog {

    /** Creates new form AddAnnotationDialog */
    public AddIndirectAnnotationDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AddIndirectAnnotationDialog dialog = new AddIndirectAnnotationDialog(new javax.swing.JFrame(), true);
