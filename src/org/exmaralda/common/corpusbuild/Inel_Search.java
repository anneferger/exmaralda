...
public class Inel_Search {
    ...
    String corpusPath = "E:\\Anne\\NganasanCorpus_Backup_08062017\\NSLC.coma";
    String firstRegEx;
    String secondRegEx;
    ...
    public void doIt(String corpusPath) throws IOException, JDOMException, InterruptedException, SAXException {
        ...
        RegularExpressionSearchParameters parameters = new RegularExpressionSearchParameters(getier, ADDITIONAL_DATA_LOCATORS, 0);
       ...
       //search.doSearch();
        ...
        AnalysisInterface[] an = {fa};
        srl.setAnalyses(an);  
        //add the ge Annotation to the Utterances        
        srl.addIndirectAnnotationAsAnalysis("ge", corpus, 1, 10, true);      
